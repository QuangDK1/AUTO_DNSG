...
public class QuanLySuKienPage {
    ...
    public void verifyMessageEditSuKienThanhCong(String messageEditthanhcong) {
        ...
        By CheckSK = By.xpath("//div[1]/div[3]/div[2]/div[2]/div[5]/div/a");

        //Check sự kiện
        public void CheckSuKienMoi() {
            WebUI.clickElement(page9thmonlyb2bUser);
            WebUI.scrollToElementWithJS(CheckSK);
            WebUI.clickElement(CheckSK);
            WebUI.sleep(2);
        }
//    public void verifyCheckSuKienThanhCong(String messageCheck) {
//        boolean Checkthanhcong = WebUI.getTextElement(MesageEditSKthanhcong).equals(messageCheck);
//        Assert.assertTrue(Checkthanhcong, "Fail");
//    }
