...
public class LoginPage {
    ...
    public void LoginThanhCongback (String email,String password){
      //  WebUI.openURL(URl);
   ...
   public void LoginAdminCheckGianHang(String email_admin, String password_admin){
       WebUI.openURL(URl);
       WebUI.setText(inputEmail,email_admin);
       WebUI.setText(inputPassword,password_admin);
       WebUI.clickElement(buttonLogin);
       WebUI.sleep(1.5);
   }
